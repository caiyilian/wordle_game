...
function keyClass(key: string): string {
  ...
  if (key === 'ENTER' || key === 'BACKSPACE') return base + ' flex-1 max-w-[3.5rem] sm:max-w-[4rem] bg-gray-300 dark:bg-gray-600 text-gray-700 dark:text-gray-200 hover:bg-gray-400 dark:hover:bg-gray-500'
